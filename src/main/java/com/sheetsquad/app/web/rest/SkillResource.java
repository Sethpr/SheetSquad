...
/**
 * REST controller for managing {@link com.sheetsquad.app.domain.Skill}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class SkillResource {
     ...
     */
    @GetMapping("/skills")
    public List<Skill> getAllSkills(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get all Skills");
        if (eagerload) {
            return skillRepository.findAllWithEagerRelationships();
        } else {
