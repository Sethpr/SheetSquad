...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './archetype.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARCHETYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARCHETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARCHETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARCHETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARCHETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARCHETYPE actions', async () => {
      const expectedActions = [
        {
