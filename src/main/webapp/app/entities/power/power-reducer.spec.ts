...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './power.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POWER_LIST actions', async () => {
    ...
    it('dispatches FETCH_POWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POWER actions', async () => {
      const expectedActions = [
        {
