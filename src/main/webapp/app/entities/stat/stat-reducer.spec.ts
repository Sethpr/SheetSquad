...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './stat.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STAT_LIST actions', async () => {
    ...
    it('dispatches FETCH_STAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STAT actions', async () => {
      const expectedActions = [
        {
