...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './quality.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUALITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_QUALITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_QUALITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_QUALITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_QUALITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_QUALITY actions', async () => {
      const expectedActions = [
        {
