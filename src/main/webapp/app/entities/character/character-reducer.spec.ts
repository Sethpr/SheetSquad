...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './character.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHARACTER_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHARACTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHARACTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHARACTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHARACTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHARACTER actions', async () => {
      const expectedActions = [
        {
