...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './extra.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXTRA_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXTRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXTRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXTRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXTRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXTRA actions', async () => {
      const expectedActions = [
        {
