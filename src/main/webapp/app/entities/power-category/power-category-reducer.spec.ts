...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POWERCATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_POWERCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POWERCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POWERCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POWERCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POWERCATEGORY actions', async () => {
      const expectedActions = [
        {
