...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BASEEXTRA_LIST actions', async () => {
    ...
    it('dispatches FETCH_BASEEXTRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BASEEXTRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BASEEXTRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BASEEXTRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BASEEXTRA actions', async () => {
      const expectedActions = [
        {
