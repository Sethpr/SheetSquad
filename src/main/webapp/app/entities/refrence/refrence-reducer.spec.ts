...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './refrence.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REFRENCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_REFRENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REFRENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REFRENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REFRENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REFRENCE actions', async () => {
      const expectedActions = [
        {
